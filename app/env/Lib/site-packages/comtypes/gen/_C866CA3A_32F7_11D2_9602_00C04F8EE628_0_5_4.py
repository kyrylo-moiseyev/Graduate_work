...
__all__ = [
    'SPDKL_LocalMachine', 'DISPID_SPIRule', 'SWTDeleted',
    'DISPID_SRCEFalseRecognition', 'SRSEDone', 'ISpeechGrammarRule',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseElement', 'SPRECOSTATE', 'SpMMAudioIn',
    'UINT_PTR', 'SPCT_SUB_DICTATION', 'DISPID_SRGetRecognizers',
    'SECFIgnoreWidth', 'SPPHRASERULE', 'SPDATAKEYLOCATION',
    'SECFIgnoreKanaType', 'ISpLexicon', 'DISPID_SRRAudioFormat',
    'DISPIDSPRG', 'DISPID_SPEActualConfidence',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPIRetainedSizeBytes', 'SPADAPTATIONRELEVANCE',
    'SPAR_High', 'SVP_13', 'DISPID_SVAlertBoundary',
    'SAFT24kHz8BitStereo', 'DISPID_SRSSupportedLanguages',
    'SpUnCompressedLexicon', 'SRSInactive', 'SAFT12kHz16BitStereo',
    'SPXRO_Alternates_SML', 'SPPS_Modifier', 'SPSERIALIZEDPHRASE',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechEngineConfidence', 'SPBO_AHEAD',
    'DISPID_SPPId', 'SpWaveFormatEx', 'DISPID_SGRClear', 'SVP_19',
    'SPEI_SOUND_END', 'DISPID_SpeechRecoResult2', 'DISPID_SAFType',
    'DISPID_SpeechXMLRecoResult', 'SITooSlow', 'SVEVoiceChange',
    'ISpeechLexiconWords', 'SPGRAMMARWORDTYPE', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE10', 'SAFTNoAssignedFormat', 'SPEI_SR_PRIVATE',
    'SSTTDictation', 'SPEI_MAX_SR', 'DISPID_SGRInitialState',
    'DISPID_SPEsItem', 'DISPID_SRCRetainedAudio',
    ...
    'SRERecoOtherContext', 'STCInprocServer',
    'SpeechAudioFormatGUIDWave', 'DISPID_SLWLangId', 'SLODynamic',
    'ISpRecoResult', 'SpTextSelectionInformation',
    'DISPID_SRAudioInput', 'DISPID_SpeechPhraseProperties', 'SRARoot',
    'SpeechRecognizerState', 'DISPID_SGRName', 'SVSFParseAutodetect',
    'ISpXMLRecoResult', 'SAFTDefault', 'DISPID_SOTIsUISupported',
    'SVF_Stressed', 'DISPID_SGRSTPropertyId', 'DISPID_SOTs_NewEnum',
    'SDTAudio', 'SDA_Consume_Leading_Spaces',
    'DISPID_SPRules_NewEnum', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechBaseStream', 'DISPID_SDKGetBinaryValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechAudio',
    'eLEXTYPE_RESERVED7', 'SAFT48kHz8BitMono', 'SPEI_TTS_PRIVATE',
    'Speech_Max_Word_Length', 'DISPID_SpeechAudioFormat',
    'DISPID_SBSSeek', 'DISPID_SOTRemove', 'DISPID_SPRsItem',
    'SPSHT_EMAIL', 'SAFT22kHz16BitStereo', 'DISPID_SRRAudio',
    'DISPID_SVPriority', 'SPGS_DISABLED', 'SVP_21',
    'SPSTREAMFORMATTYPE', 'SpeechDictationTopicSpelling',
    ...
    'ISpSerializeState', 'ISpObjectTokenCategory', 'SPLEXICONTYPE',
    ...
    'SP_VISEME_17', 'SAFT24kHz8BitMono', 'SVP_5',
    ...
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSTsCount',
    'ISpeechGrammarRuleState', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechCustomStream', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechPhraseInfo', 'SPEI_SOUND_START',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPRuleNumberOfElements',
    'SpObjectToken', 'ISpProperties', 'DISPID_SRCRecognizer',
    'SVP_15', 'DISPID_SWFEBlockAlign', 'DISPID_SPCLangId',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCESoundStart',
    'DISPID_SVEWord', 'SPEI_FALSE_RECOGNITION', 'SPEI_RESERVED5',
    'eLEXTYPE_PRIVATE8', 'SPRULESTATE', 'DISPID_SBSRead',
    'DISPID_SOTsItem', 'SPRECOGNIZERSTATUS', 'SAFT32kHz8BitMono',
    'SAFT22kHz16BitMono', 'SVSFIsNotXML', 'SpVoice',
    'SPEI_REQUEST_UI', 'SPGRAMMARSTATE', 'SGRSTTWildcard',
    'ISpNotifySink', 'SAFT8kHz8BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SSSPTRelativeToStart', 'ISpeechDataKey', 'SAFT16kHz16BitStereo',
    'SVP_6', 'SPAUDIOBUFFERINFO', 'SpeechInterference',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRSRule', 'DISPID_SGRId',
    'SRSInactiveWithPurge', 'SPRST_INACTIVE_WITH_PURGE',
    'SPPHRASEREPLACEMENT', 'DISPID_SDKEnumValues', 'SPCT_SUB_COMMAND',
    'SPINTERFERENCE_TOOLOUD', 'SpeechWordPronounceable',
    'eLEXTYPE_RESERVED4', 'SVESentenceBoundary',
    'IInternetSecurityMgrSite', 'SpeechPropertyComplexResponseSpeed',
    'STCAll', 'DISPID_SGRs_NewEnum', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRRDiscardResultInfo', 'SAFT48kHz8BitStereo',
    'SVSFPersistXML', 'SVSFNLPSpeakPunc', 'SRADynamic',
    'DISPID_SVSInputWordLength', 'DISPID_SPIEnginePrivateData',
    'SPRS_ACTIVE', 'DISPID_SLGenerationId', 'DISPID_SVVolume',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SGRsAdd',
    'SREAudioLevel', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechVoiceStatus', 'SpeechCategoryRecoProfiles',
    'SpeechLexiconType', 'SRAExport', 'SPXMLRESULTOPTIONS',
    'ISpeechRecoResult', 'DISPID_SRCERecognitionForOtherContext',
    'SPEI_ADAPTATION', 'ISpEventSink', 'DISPID_SRRTStreamTime',
    'SPVPRI_OVER', 'SpeechRuleState', 'DISPID_SRProfile',
    'SPEI_START_SR_STREAM', 'DISPID_SPPFirstElement',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRADefaultToActive',
    'SPRST_NUM_STATES', 'DISPID_SGRSAddRuleTransition',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPRuleEngineConfidence',
    'SPSFunction', 'DISPID_SpeechLexiconProns', 'DISPID_SVEViseme',
    'DISPID_SLPsCount', 'SDKLCurrentConfig', 'DISPID_SVSVisemeId',
    'SVEEndInputStream', 'DISPID_SGRSTransitions', 'DISPID_SOTId',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_USER', 'ISpeechPhraseRules',
    'SP_VISEME_7', 'tagSTATSTG', 'SREAllEvents',
    'SAFTCCITT_ALaw_8kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SINoise',
    'ISpeechPhraseAlternate', 'DISPID_SGRSTRule',
    'DISPID_SRGetFormat', 'DISPID_SpeechRecoResult',
    'SPSInterjection', 'SSTTWildcard', 'SRERecognition',
    'DISPID_SGRsCount', 'DISPID_SRIsUISupported', 'SRERequestUI',
    'DISPID_SWFEExtraData', 'DISPID_SPPsItem', 'SRTExtendableParse',
    'ISequentialStream', 'SpeechGrammarTagDictation',
    'DISPID_SPIGetDisplayAttributes', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE7',
    'SpPhoneticAlphabetConverter', 'SVSFParseSapi',
    'DISPID_SGRSTPropertyName', 'SAFT22kHz8BitStereo',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SDKDeleteKey',
    'DISPID_SVPause', 'SP_VISEME_1', 'SpeechVoiceSpeakFlags',
    'SREStateChange', 'SBOPause', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVESentenceBoundary', 'DISPID_SMSADeviceId',
    'DISPID_SRSetPropertyString', 'SAFTExtendedAudioFormat',
    'DISPID_SRRAlternates', 'SVSFParseMask', 'SP_VISEME_11',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRSAddWordTransition',
    'SPRST_ACTIVE', 'SECFDefault',
    'SpeechPropertyLowConfidenceThreshold', 'SPPHRASEPROPERTY',
    'SpeechGrammarWordType', 'ISpeechGrammarRuleStateTransition',
    'ISpeechMMSysAudio', 'SRAONone', 'SPEI_PHONEME',
    'ISpeechObjectTokens', 'SAFT44kHz16BitMono', 'DISPID_SVStatus',
    'STSF_CommonAppData', 'SPAUDIOSTATUS', 'SGSExclusive',
    'DISPID_SGRsCommit', 'DISPID_SVSRunningState', 'SPSSuppressWord',
    'DISPID_SRSNumberOfActiveRules', 'SPWORDTYPE', 'SpStream',
    'ISpeechObjectToken', 'DISPID_SpeechAudio', 'SSFMOpenForRead',
    'ISpStream', 'SPRST_ACTIVE_ALWAYS', 'SPBO_NONE',
    'DISPID_SPERetainedStreamOffset', 'SPWORD',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRsFindRule',
    'DISPID_SASetState', 'SPPS_NotOverriden', 'typelib_path',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SVEStreamEnd',
    ...
    'SpeechVoiceSkipTypeSentence', 'SAFT32kHz8BitStereo',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechVoiceEvent',
    'SWTAdded', 'SpMemoryStream', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SWPKnownWordPronounceable', 'LONG_PTR', 'ISpeechWaveFormatEx',
    'ISpeechLexiconWord', 'SDKLDefaultLocation',
    'SpInProcRecoContext', 'DISPID_SMSAMMHandle',
    'ISpeechCustomStream', 'SpeechDiscardType',
    'DISPID_SRCEStartStream', 'SVEStartInputStream', 'SVP_14',
    'SASPause', 'SpPhoneConverter', 'ISpeechPhraseProperty',
    'DISPID_SASCurrentSeekPosition', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVSInputWordPosition', 'ISpPhrase',
    'SpeechDisplayAttributes', 'DISPID_SOTGetStorageFileName',
    'SVF_None', 'ISpRecoContext', 'SVP_8', 'SPEI_RESERVED6', 'SVP_17',
    'SAFT12kHz16BitMono', 'eLEXTYPE_RESERVED6', 'SpeechVisemeFeature',
    'SpMMAudioEnum', 'DISPID_SGRAttributes', 'DISPID_SVSLastBookmark',
    'DISPID_SRCEventInterests', 'ISpeechVoice', 'SPPHRASE',
    'SpNullPhoneConverter', 'ISpPhraseAlt', 'DISPID_SVSpeakStream',
    'SpeechVisemeType', 'DISPID_SRDisplayUI', 'ISpRecoCategory',
    'DISPID_SpeechAudioStatus', 'SP_VISEME_9', 'SPCS_ENABLED',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCERecognition',
    'SpeechMicTraining', 'DISPID_SpeechPhraseRules',
    'SpeechUserTraining', 'DISPID_SVRate', 'SVSFPurgeBeforeSpeak',
    'DISPID_SOTCreateInstance', 'DISPID_SMSGetData',
    'ISpeechPhraseInfoBuilder', 'SpeechEngineProperties',
    'DISPID_SMSSetData', 'DISPID_SWFEBitsPerSample', 'SDTProperty',
    'SpeechPropertyAdaptationOn', 'SGLexical',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRSTsItem',
    'STCLocalServer', 'DISPID_SPAsItem',
    'DISPID_SPERetainedSizeBytes', 'SPRULE',
    'DISPID_SRCEInterference', 'ISpeechObjectTokenCategory',
    'DISPID_SBSFormat', 'SPPHRASEELEMENT', 'eLEXTYPE_APP',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechAudioFormatType', 'SVP_12', 'DISPID_SRStatus',
    'DISPID_SRRRecoContext', 'SpeechPropertyResponseSpeed',
    'ISpeechRecoResult2', 'SLTApp', 'DISPID_SLWsCount',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFT32kHz16BitStereo',
    'DISPID_SVVoice', 'DISPID_SWFEChannels', 'SPEI_RESERVED1',
    'SRAORetainAudio', 'SPAR_Low', 'SPBO_TIME_UNITS', 'SP_VISEME_6',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechRecoContext', 'ISpeechTextSelectionInformation',
    'ISpMMSysAudio', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpGrammarBuilder', 'DISPID_SVEventInterests', 'SpeechRunState',
    'SPEI_VISEME', 'DISPID_SRSetPropertyNumber',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPEs_NewEnum',
    'SPEVENT', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechPhoneConverter', 'DISPID_SRRTLength',
    'DISPID_SRAudioInputStream', 'ISpPhoneConverter',
    'DISPID_SPPsCount', 'DISPID_SRRSetTextFeedback',
    'SVSFUnusedFlags', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCEEndStream', 'SVSFIsXML',
    'DISPID_SPAStartElementInResult', 'SpeechBookmarkOptions',
    'STCInprocHandler', 'SPSMF_UPS', 'SpeechFormatType',
    'DISPID_SpeechWaveFormatEx', 'SREHypothesis',
    'DISPID_SpeechPhraseReplacement', 'SPAR_Medium', 'ISpeechLexicon',
    'DISPID_SRCCreateGrammar', 'SPPS_Noun', 'SPVISEMES',
    'DISPID_SPPParent', 'DISPID_SDKCreateKey', 'DISPID_SPAPhraseInfo',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGCmdLoadFromObject',
    'SP_VISEME_15', 'DISPID_SLPPhoneIds', 'DISPID_SOTDisplayUI',
    'eLEXTYPE_RESERVED8', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SLRemovePronunciation', 'SGRSTTWord',
    'DISPID_SLWPronunciations', 'DISPID_SGRSTText', 'DISPID_SRGRules',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPPs_NewEnum',
    'DISPID_SABufferInfo', 'DISPID_SpeechGrammarRules', 'SPWF_INPUT',
    'IEnumString', 'SRCS_Enabled', 'SVEAudioLevel', 'SREAdaptation',
    'SRTEmulated', 'SPRECORESULTTIMES', 'Speech_StreamPos_Asap',
    'SPVPRI_ALERT', 'DISPID_SRGCommit', 'SPSNotOverriden',
    ...
    'DISPID_SPIReplacements', 'DISPID_SAStatus',
    'DISPIDSPTSI_SelectionLength', 'SPAO_NONE', 'SITooLoud',
    'DISPID_SRRTTickCount', 'DISPID_SRRSaveToMemory',
    'SpeechRuleAttributes', 'ISpeechPhraseElements',
    'SAFT12kHz8BitMono', 'DISPID_SWFEAvgBytesPerSec', 'SPAS_STOP',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SpeechFileStream',
    'SVP_4', 'SpMMAudioOut', 'DISPID_SRCResume', 'SP_VISEME_8',
    'SPLOADOPTIONS', 'DISPID_SRCBookmark', 'SGRSTTRule',
    'DISPID_SPELexicalForm', 'DISPID_SpeechRecoResultTimes',
    'SAFT44kHz8BitStereo', 'ISpRecognizer2', 'SAFT16kHz8BitMono',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SVWaitUntilDone',
    'SGRSTTEpsilon', 'SVEAllEvents', 'SAFTGSM610_22kHzMono',
    'SAFT8kHz16BitMono', 'DISPID_SGRsDynamic',
    'DISPID_SOTCGetDataKey', 'ISpeechRecoResultTimes',
    'DISPID_SRCPause', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPEI_RECOGNITION', 'DISPID_SLWWord', 'SVP_1', 'SVP_18',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_ALaw_8kHzMono', 'SpPhraseInfoBuilder',
    'DISPID_SVEBookmark', 'DISPID_SVSLastResult', 'SAFT22kHz8BitMono',
    'DISPID_SPPName', 'SREStreamEnd', 'SPDKL_CurrentUser',
    'SREPhraseStart', 'SPAR_Unknown',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLPLangId',
    'SAFT44kHz8BitMono', 'SP_VISEME_19', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechDataKey', 'SPSHT_OTHER', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPAsCount', 'eWORDTYPE_ADDED', 'SRSActiveAlways',
    'SPFM_OPEN_READONLY', 'eLEXTYPE_PRIVATE11',
    'SpeechCategoryRecognizers', 'SPSNoun', 'SP_VISEME_16',
    'SPGS_EXCLUSIVE', 'SREStreamStart', 'DISPID_SGRSTNextState',
    'SINoSignal', 'SVEPrivate', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT11kHz8BitMono', 'SRSEIsSpeaking', 'SVP_2',
    'SpInprocRecognizer', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SRRTimes',
    'Speech_StreamPos_RealTime', 'SRAInterpreter',
    'DISPID_SVAudioOutput', 'SpeechTokenKeyFiles',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLPSymbolic',
    'SpeechRecoContextState', 'ISpeechGrammarRuleStateTransitions',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpNotifyTranslator',
    'SGRSTTDictation', 'DISPID_SpeechPhraseAlternate', 'SpShortcut',
    'SVF_Emphasis', 'SAFT48kHz16BitMono',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechRecoContext',
    'SPEI_MAX_TTS', 'SPEVENTENUM', 'DISPID_SVEStreamStart',
    'SAFTGSM610_11kHzMono', 'SPCATEGORYTYPE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAS_PAUSE', 'SPPS_RESERVED1',
    'SGRSTTTextBuffer', 'ISpeechPhraseProperties',
    'SAFT11kHz16BitMono', 'DISPID_SpeechPhoneConverter',
    'STSF_AppData', 'DISPID_SRGState', 'SpCompressedLexicon',
    'SGSEnabled', 'SSSPTRelativeToEnd', 'ISpResourceManager',
    'DISPID_SVGetAudioInputs', 'DISPID_SRRGetXMLResult',
    'SPCT_COMMAND', 'SpeechAllElements', 'DISPID_SPIAudioSizeBytes',
    'ISpeechXMLRecoResult', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPRST_INACTIVE', 'DISPID_SpeechAudioBufferInfo',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_ALaw_11kHzStereo', 'SGDisplay', 'SAFTADPCM_44kHzMono',
    'SFTInput', '_ISpeechRecoContextEvents', 'SpeechDataKeyLocation',
    'SPSUnknown', 'SECFIgnoreCase', 'SPSEMANTICERRORINFO',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_PRIVATE12', 'SGDSInactive',
    'DISPID_SDKGetStringValue', 'SECLowConfidence',
    'DISPID_SGRSTType', 'DISPID_SRCEBookmark', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechObjectToken', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SBSWrite', 'DISPID_SREmulateRecognition',
    'SREInterference', 'DISPID_SGRSTPropertyValue', 'SPWF_SRENGINE',
    'SPWORDLIST', 'DISPID_SPRuleConfidence',
    'DISPID_SPEEngineConfidence', 'DISPID_SGRSTWeight', 'SASStop',
    'DISPID_SGRsCommitAndSave', 'SpeechTokenKeyAttributes',
    'DISPID_SRIsShared', 'SAFTCCITT_uLaw_11kHzMono', 'SVP_11',
    'SAFT32kHz16BitMono', 'DISPID_SRCEAudioLevel',
    'DISPID_SPEDisplayAttributes', 'SPWORDPRONUNCIATIONLIST',
    'eLEXTYPE_PRIVATE20', 'DISPID_SLWs_NewEnum', 'eLEXTYPE_PRIVATE16',
    'SPINTERFERENCE_NOSIGNAL', 'SPSHT_Unknown',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKOpenKey', 'SRTSMLTimeout',
    'SRESoundEnd', 'SVP_3', 'ISpeechRecognizerStatus',
    'DISPID_SRSAudioStatus', 'SAFT44kHz16BitStereo', 'SPSHORTCUTPAIR',
    'DISPID_SPEPronunciation', 'SpAudioFormat',
    'DISPID_SPRuleFirstElement', 'SpeechGrammarState',
    'SRESoundStart', 'SGLexicalNoSpecialChars', 'DISPIDSPTSI',
    ...
    'DISPID_SpeechRecognizer', 'SPLO_STATIC',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechCategoryVoices', 'SVP_10',
    'SVSFlagsAsync', 'DISPID_SAFGetWaveFormatEx',
    'SpeechCategoryAppLexicons', 'SPDKL_DefaultLocation',
    'DISPID_SPRuleChildren', 'ISpVoice', 'SECHighConfidence',
    'SP_VISEME_10', 'DISPID_SLAddPronunciationByPhoneIds', 'SLTUser',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SOTGetDescription', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechTokenValueCLSID', 'DISPID_SAEventHandle',
    'DISPID_SDKDeleteValue', 'DISPID_SOTCategory',
    'SAFT24kHz16BitMono', 'SPFILEMODE', 'ISpStreamFormatConverter',
    'SpStreamFormatConverter', 'SPRS_INACTIVE',
    'SpeechGrammarTagWildcard', 'SpeechPropertyResourceUsage',
    'SP_VISEME_3', 'SPSEMANTICFORMAT', 'DISPID_SPPConfidence',
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_PRIVATE5',
    'SWPUnknownWordPronounceable', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpStreamFormat', 'DISPID_SABIBufferSize',
    'DISPID_SRGSetTextSelection', 'SPCT_SLEEP', 'SPEI_SR_BOOKMARK',
    'DISPID_SOTSetId', 'SPCS_DISABLED', 'ISpeechVoiceStatus',
    'SpeechVoicePriority', 'SRCS_Disabled', 'SPXRO_SML',
    'SDTReplacement', 'DISPID_SLPType', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVGetVoices', 'DISPID_SRGRecoContext',
    'DISPID_SRRPhraseInfo', 'DISPID_SCSBaseStream', 'SPPS_Noncontent',
    'DISPID_SOTCId', 'DISPID_SOTCSetId', 'SPEI_RESERVED3',
    'SpeechAudioProperties', 'SDTAll', 'DISPID_SABIMinNotification',
    'SASClosed', 'ISpPhoneticAlphabetConverter', 'SPEI_MIN_TTS',
    'DISPID_SLGetWords', 'SPBO_PAUSE', 'SPEI_END_SR_STREAM',
    'SAFTGSM610_8kHzMono', 'SDTPronunciation', 'SECNormalConfidence',
    'SVP_16', 'SP_VISEME_12', 'DISPID_SpeechPhraseAlternates',
    'SPINTERFERENCE', 'SP_VISEME_13', 'SPWT_PRONUNCIATION',
    'SAFT11kHz8BitStereo', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechLexicon', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIEngineId', 'DISPID_SVSCurrentStreamNumber',
    'SP_VISEME_2', 'eLEXTYPE_PRIVATE6', 'ISpShortcut',
    'SpeechLoadOption', 'DISPID_SMSALineId', 'SREBookmark',
    'SAFT16kHz16BitMono', 'SAFTText', 'SSFMOpenReadWrite',
    'SPSModifier', 'SDKLLocalMachine', 'SPPS_Interjection',
    'SAFT48kHz16BitStereo', 'eLEXTYPE_PRIVATE19',
    'SAFTADPCM_8kHzMono', 'SDTLexicalForm', 'SPGS_ENABLED',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRGSetWordSequenceData', 'SpeechStreamFileMode',
    'SRTReSent', 'DISPID_SGRAddState', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechObjectTokens',
    'ISpeechRecoGrammar', 'DISPID_SRCEEnginePrivate',
    'SPEVENTSOURCEINFO', 'SP_VISEME_4', 'ISpeechPhraseReplacement',
    'SPPARTOFSPEECH', 'tagSPPROPERTYINFO',
    'DISPID_SRGIsPronounceable', 'DISPID_SPPChildren',
    'SPRECOCONTEXTSTATUS', 'SAFTADPCM_8kHzStereo', 'SpeechAudioState',
    'SRTStandard', 'DISPID_SVEEnginePrivate', 'SpeechTokenKeyUI',
    'DISPID_SPCIdToPhone', 'SVSFIsFilename', 'SpeechWordType',
    'SSTTTextBuffer', 'DISPID_SAVolume', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRCERequestUI', 'DISPID_SVResume', 'ISpeechAudioStatus',
    'DISPID_SGRsItem', 'WAVEFORMATEX', 'DISPID_SpeechVoice',
    'DISPID_SPRuleParent', 'SpeechRetainedAudioOptions',
    'SPWAVEFORMATTYPE', 'DISPID_SABIEventBias', 'SDTDisplayText',
    'DISPID_SPACommit', 'SpFileStream', 'SAFT24kHz16BitStereo',
    'SpeechEmulationCompareFlags', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVAudioOutputStream', 'SAFTADPCM_22kHzStereo',
    'SGPronounciation', 'DISPID_SPRText', 'SPWT_LEXICAL',
    'Speech_Max_Pron_Length', 'SVSFVoiceMask',
    'DISPID_SRGCmdLoadFromResource', 'DISPIDSPTSI_ActiveOffset',
    'ISpRecognizer3', 'SPINTERFERENCE_TOOFAST', 'SAFTADPCM_11kHzMono',
    'eLEXTYPE_PRIVATE2', 'DISPID_SABufferNotifySize',
    'SPAUDIOOPTIONS', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRGetPropertyString', 'SITooFast', 'eWORDTYPE_DELETED',
    'DISPID_SOTDataKey', 'SRAImport', 'SpResourceManager',
    'SRSActive', 'DISPID_SRGDictationLoad', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechPhraseProperty', 'ISpeechPhraseInfo',
    'ISpeechAudioBufferInfo', 'SGDSActive', 'SVEWordBoundary',
    'DISPID_SPARecoResult', 'SINone', 'SLOStatic',
    'DISPID_SPILanguageId', 'SP_VISEME_20', 'SPFM_NUM_MODES',
    'SPVPRIORITY', 'ISpRecoContext2', 'DISPID_SVSPhonemeId',
    'SPSERIALIZEDRESULT', 'SVEViseme', 'DISPID_SpeechPhraseBuilder',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_INTERFERENCE',
    'SPBINARYGRAMMAR', 'SVPNormal', 'SpCustomStream', 'ISpRecognizer',
    'ISpObjectToken', 'SAFTCCITT_ALaw_22kHzMono',
    'SREPropertyNumChange', 'DISPID_SRCRequestedUIType',
    'SPAS_CLOSED', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED9', 'SpeechCategoryAudioIn',
    'DISPID_SpeechMemoryStream', 'SPPROPERTYINFO', 'SP_VISEME_5',
    'DISPID_SRCCreateResultFromMemory', 'SPPS_RESERVED3',
    'SAFT12kHz8BitStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRSpeakAudio',
    'SPWORDPRONUNCIATION', 'ISpEventSource',
    'DISPID_SpeechGrammarRule', 'ISpNotifySource', 'SREPrivate',
    'SPEI_UNDEFINED', 'ISpDataKey', 'DISPID_SASState', 'SPSLMA',
    'SP_VISEME_18', 'DISPID_SOTCDefault', 'SDA_No_Trailing_Space',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechMMSysAudio',
    'DISPID_SFSClose', 'SP_VISEME_21', 'SBONone',
    'DISPID_SWFEFormatTag', 'DISPID_SPPNumberOfElements', 'IStream',
    'SpNotifyTranslator',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '_RemotableHandle', 'ISpeechAudioFormat', 'SVSFParseSsml',
    'IEnumSpObjectTokens', 'SVP_20', 'SPCONTEXTSTATE',
    'DISPID_SVGetAudioOutputs', 'ISpAudio', 'DISPID_SPPValue',
    'ISpRecoGrammar', 'DISPID_SVEPhoneme', 'SVPOver',
    'SPINTERFERENCE_TOOSLOW', 'SAFT8kHz16BitStereo', 'DISPID_SVSkip',
    ...
    'SPEI_RESERVED2', 'DISPID_SVEAudioLevel', 'DISPID_SPRuleName',
    'DISPID_SPIElements', 'DISPID_SPEDisplayText', 'SSFMCreate',
    'DISPID_SRCESoundEnd', 'SpeechVoiceEvents', 'SPAO_RETAIN_AUDIO',
    'SpeechPartOfSpeech', 'DISPID_SRGReset', 'SPWT_DISPLAY',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SLGetGenerationChange',
    'STSF_FlagCreate', 'SAFTCCITT_uLaw_22kHzMono',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE14', '_SPAUDIOSTATE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRSClsidEngine',
    'SPPS_LMA', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPIStartTime', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_MIN_SR', 'SGSDisabled', 'SPAUDIOSTATE',
    'DISPID_SOTGetAttribute', 'DISPID_SRRecognizer',
    'DISPID_SPRulesCount', 'DISPID_SLWsItem', 'SPSVerb',
    'DISPID_SVSLastBookmarkId', 'SPPS_RESERVED2', 'DISPID_SRState',
    'SPFM_CREATE', 'SITooQuiet', 'ISpeechBaseStream',
    'SPBOOKMARKOPTIONS', 'SpSharedRecognizer',
    'ISpeechPhraseReplacements', 'DISPID_SRCVoice',
    'STSF_LocalAppData', 'DISPID_SGRSTs_NewEnum', 'SpLexicon',
    'DISPID_SPRsCount', 'DISPID_SPIGetText', 'SAFT8kHz8BitStereo',
    'SRTAutopause', 'DISPID_SpeechPhraseElements',
    'DISPID_SRGCmdSetRuleState', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIProperties', 'SP_VISEME_14', 'SREPropertyStringChange',
    'Speech_Default_Weight', 'SpSharedRecoContext', 'SVEBookmark',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVGetProfiles',
    'DISPID_SGRAddResource', 'Library', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGDictationSetState', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRCEHypothesis', 'DISPID_SVEVoiceChange',
    'SPEI_END_INPUT_STREAM',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechPhraseRule',
    'SDKLCurrentUser', 'DISPID_SFSOpen', 'SAFTNonStandardFormat',
    'SPEI_VOICE_CHANGE', 'SDA_One_Trailing_Space',
    'DISPID_SpeechLexiconWord', 'DISPID_SLPsItem',
    'SpeechTokenShellFolder', 'eLEXTYPE_PRIVATE18',
    'SGDSActiveWithAutoPause', 'SPPS_SuppressWord',
    'DISPID_SDKSetStringValue', 'SPCT_DICTATION',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SLWType',
    'DISPID_SDKGetlongValue', 'SRATopLevel', 'eLEXTYPE_PRIVATE15',
    'DISPID_SDKSetLongValue', 'ISpRecoGrammar2',
    'SpObjectTokenCategory', 'SPPS_Function',
    'SpeechTokenIdUserLexicon', 'SREFalseRecognition',
    'SpeechRecoEvents', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRGId', 'ISpeechResourceLoader', 'SPINTERFERENCE_NONE',
    ...
    'SVSFNLPMask', 'DISPID_SADefaultFormat', 'ISpObjectWithToken',
    'SDTRule', 'DISPID_SPPEngineConfidence', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPRs_NewEnum', 'SPSHT_NotOverriden', 'SPAS_RUN',
    'SPPS_Unknown', 'SPVOICESTATUS', 'DISPID_SPRFirstElement',
    'SSFMCreateForWrite', 'DISPID_SPAs_NewEnum',
    'ISpeechGrammarRules', 'SVP_7', 'SpeechAudioVolume',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechAddRemoveWord', 'SECFEmulateResult',
    'SpeechAudioFormatGUIDText', 'SVP_9', 'ISpeechRecognizer',
    'DISPID_SVSpeak', 'DISPID_SOTsCount', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPCPhoneToId', 'SPSHORTCUTTYPE',
    'SAFT11kHz16BitStereo', 'SVSFDefault', 'DISPID_SPRulesItem',
    'ISpeechFileStream', 'SPPS_Verb', 'SASRun',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_0',
    'DISPID_SpeechLexiconWords', 'SpeechTokenContext',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SLPs_NewEnum',
    'DISPID_SPRuleId', 'SPLO_DYNAMIC', 'SFTSREngine', 'SPPS_RESERVED4'
]

_check_version('1.4.0', 1718198134.174755)
